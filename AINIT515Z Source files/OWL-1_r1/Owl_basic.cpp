    ...
    while (inLOOP){
        ...
        while (inLOOP){
            ...
            case 'X': // Take an image with both eyes. This is used to take photos for the calibration of the cameras
                           LeftSTR = "C:/Users/hahn/Documents/Repository-OWL_cv3_r4/Repository-OWL_cv3/CalPA/Left" + to_string(Number) + ".jpg";
                           imwrite(LeftSTR, Left);

                           RightSTR = "C:/Users/hahn/Documents/Repository-OWL_cv3_r4/Repository-OWL_cv3/CalPA/Right" + to_string(Number) + ".jpg";
