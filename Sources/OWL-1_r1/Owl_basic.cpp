...
using namespace std;
using namespace cv;
int Number = 1; //camera image number for image saving
...
int main(int argc, char *argv[])
{
    ...
    string CMD;
    int N;
cout  << "motor before " << endl;
    Rx = RxLm; Lx = LxLm;
    Ry = RyC; Ly = LyC;
    Neck= NeckC;
cout  << "motor after " << endl;
...
cout  << "while " << endl;
    while (inLOOP){
        ...
        while (inLOOP){
            ...
            case 'X': // Take an image with both eyes. This is used to take photos for the calibration of the cameras
                           LeftSTR = "C:/Users/bwickenden/Documents/Repository-OWL_cv3_r4/Repository-OWL_cv3/CalPA/Left" + to_string(Number) + ".jpg";
                           imwrite(LeftSTR, Left);

                           RightSTR = "C:/Users/bwickenden/Documents/Repository-OWL_cv3_r4/Repository-OWL_cv3/CalPA/Right" + to_string(Number) + ".jpg";
                           imwrite(RightSTR, Right);

                           printf("Image Saved: %d \n\r", Number); // Prints the number of the current photo
                           Number++;

                           break;

            case 'r': // manualy calibrated reset button, all servos to centre positions
                            Lx = 1435; Rx = 1460;
                            Ly = 1575; Ry = 1495;
                            Neck= 1490;
                            break;
